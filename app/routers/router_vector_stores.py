...
@router_vector_stores.post("/create_vector_store", response_model=VectorStoreResponse)
...
@router_vector_stores.get("/list_vector_stores", response_model=ListVectorStoresResponse)
...
@router_vector_stores.get("/retrieve_vector_store/{vector_store_id}", response_model=VectorStoreResponse)
...
@router_vector_stores.delete("/delete_vector_store/{vector_store_id}", response_model=DeleteVectorStoreResponse)
